...
class Reciever : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_reciever, container, false)
        ...
        sender.arguments=bundle
        sendButton = view.findViewById(R.id.buttonSend)
        sendButton.setOnClickListener {
            val fragmentTransaction : FragmentTransaction = parentFragmentManager.beginTransaction()
            fragmentTransaction.replace(R.id.nav_container,sender).commit()
            sendMessage()
        }
        // Recieve Data
        val data = arguments
    ...
    private fun sendMessage() {
        ...
        if (username.isNotEmpty() && message.isNotEmpty()) {
            ...
            Toast.makeText(requireContext(), "Please enter username and message", Toast.LENGTH_LONG)
                .show()
        }
